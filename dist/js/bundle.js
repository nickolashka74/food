...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getRecource)('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, showModalByTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)('http://localhost:3000/requests', json).then(function (data) {
        ...
        return showThanksModal(message.fail);
      })["finally"](function () {
        return form.reset();
      });
    });
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)('.modal', showModalByTimerId);
...
function openModal(modalSelector, showModalByTimerId) {
...
function modal(modalSelector, triggerSelector, showModalByTimerId) {
  //Modal
  var modal = document.querySelector(modalSelector),
      modalTrigger = document.querySelectorAll(triggerSelector);
  modalTrigger.forEach(function (btn) {
    btn.addEventListener('click', function () {
      openModal(modalSelector, showModalByTimerId);
    });
  });
...
function slider(_ref) {
  ...
  var slideIndex = 1;
  var offset = 0;
  total.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(slides.length);
  current.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(slideIndex);
  sliderField.style.cssText = "\n        width: ".concat(slides.length, "00%;\n        display: flex;\n        transition: .5s all;\n    ");
...
function tabs(tabsParentSelector, tabsSelector, tabsContentSelector, activeClass) {
  //Tabs
  var tabParent = document.querySelector(tabsParentSelector),
...
document.addEventListener('DOMContentLoaded', function () {
  var showModalByTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', showModalByTimerId);
  }, 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.default)('.tabheader__items', '.tabheader__item', '.tabcontent', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.default)('.modal', '[data-modal]', showModalByTimerId);
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)('form', showModalByTimerId);
...
/*!*************************************!*\
  ...
  \*************************************/
/*! namespace exports */
/*! export getRecource [provided] [no usage info] [missing usage info prevents renaming] */
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(res.url, ", status: ").concat(res.status));
